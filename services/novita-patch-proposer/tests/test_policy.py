...
# Generated by the real TypeScript `novitaPatchProposerRuntimeConfigDigest`
# test fixture in src/lib/novita-patch-proposer-runtime-config.server.test.ts.
REORDERED_TRAILING_SLASH_DIGEST = "308647ce6fb91d0d59f9b1947156afd7c00281db1681604e691b21b252e173b2"
...
def environment(config: dict[str, object] | None = None) -> dict[str, str]:
    config = runtime_config() if config is None else config
    return {
...
def reordered_trailing_slash_runtime_config() -> dict[str, object]:
    """Same values as runtime_config, deliberately inserted in another order."""
    return {
        "requestLimits": {"timeoutMs": 30000, "maxTurns": 1, "maxOutputTokens": 800, "maxInputBytes": 12000},
        "endpointAuth": "hmac-sha256-v1",
        "api": "openai-chat-completions",
        "quantization": "gptq-int4",
        "imageDigest": "sha256:c2f3b1b964e47809b722b5e75b61b1e7b39a50f70388cf2bf2418f16a9f31da2",
        ...
        "modelId": "Qwen/Qwen2.5-Coder-14B-Instruct-GPTQ-Int4",
        "endpointId": "endpoint_123456",
        "configDigest": REORDERED_TRAILING_SLASH_DIGEST,
        "adapterId": "novita-qwen-patch-proposer-v1",
        "lifecycle": {
            "healthPath": "/healthz",
            "startupCommand": "python -m adapter.app",
...
class PolicyTests(unittest.TestCase):
    ...
    def test_accepts_reordered_nested_keys_with_the_actual_typescript_digest(self) -> None:
        config = reordered_trailing_slash_runtime_config()
        loaded = load_config(environment(config))
        self.assertEqual(loaded.model_id, config["modelId"])
        self.assertTrue(authorizes("Bearer " + endpoint_bearer(config), loaded))
