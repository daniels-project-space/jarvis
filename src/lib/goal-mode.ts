...
export function validatorTask(args: {
  ...
  const prompt = [
    ...
    "For a pass, copy metric, target, measurementWindow, and every satisfied stop-condition sentence verbatim from the accepted outcome contract. Do not paraphrase them. If any accepted condition is contradicted or not evidenced, return refine or blocked instead of pass.",
