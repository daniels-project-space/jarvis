...
export function configuredCloudWorkspaceProvider(
  ...
  return configuredCloudWorkspaceProviderForName(env, name as CloudWorkspaceProviderName, requireExecutionCapabilities);
}

export function configuredCloudWorkspaceProviderForName(
  env: Readonly<Record<string, string | undefined>>,
  ...
  else throw new CloudWorkspaceError("cloudflare", "invalid_configuration", "unknown persisted cloud workspace provider");
