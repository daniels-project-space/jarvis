...
// node_modules/@s2-dev/streamstore/dist/esm/types.js
init_esm();
...
var StreamPosition$Type = class extends import_runtime12.MessageType {
  static {
  ...
  create(value2) {
    ...
    if (value2 !== void 0)
      (0, import_runtime11.reflectionMergePartial)(this, message, value2);
    return message;
  }
  internalBinaryRead(reader, length, options, target) {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.seqNum !== 0n)
      writer.tag(1, import_runtime9.WireType.Varint).uint64(message.seqNum);
    if (message.timestamp !== 0n)
      writer.tag(2, import_runtime9.WireType.Varint).uint64(message.timestamp);
    let u = options.writeUnknownFields;
    if (u !== false)
...
var Header$Type = class extends import_runtime12.MessageType {
  static {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.name.length)
      writer.tag(1, import_runtime9.WireType.LengthDelimited).bytes(message.name);
    if (message.value.length)
      writer.tag(2, import_runtime9.WireType.LengthDelimited).bytes(message.value);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? import_runtime10.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
...
var AppendRecord$Type = class extends import_runtime12.MessageType {
  static {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.timestamp !== void 0)
      writer.tag(1, import_runtime9.WireType.Varint).uint64(message.timestamp);
    for (let i = 0; i < message.headers.length; i++)
      Header.internalBinaryWrite(message.headers[i], writer.tag(2, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    if (message.body.length)
      writer.tag(3, import_runtime9.WireType.LengthDelimited).bytes(message.body);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? import_runtime10.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
...
var AppendInput$Type = class extends import_runtime12.MessageType {
  static {
  ...
  internalBinaryWrite(message, writer, options) {
    for (let i = 0; i < message.records.length; i++)
      AppendRecord2.internalBinaryWrite(message.records[i], writer.tag(1, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    if (message.matchSeqNum !== void 0)
      writer.tag(2, import_runtime9.WireType.Varint).uint64(message.matchSeqNum);
    if (message.fencingToken !== void 0)
      writer.tag(3, import_runtime9.WireType.LengthDelimited).string(message.fencingToken);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? import_runtime10.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
...
var AppendAck$Type = class extends import_runtime12.MessageType {
  static {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.start)
      StreamPosition.internalBinaryWrite(message.start, writer.tag(1, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    if (message.end)
      StreamPosition.internalBinaryWrite(message.end, writer.tag(2, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    if (message.tail)
      StreamPosition.internalBinaryWrite(message.tail, writer.tag(3, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? import_runtime10.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
...
var SequencedRecord$Type = class extends import_runtime12.MessageType {
  static {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.timestamp !== 0n)
      writer.tag(2, import_runtime9.WireType.Varint).uint64(message.timestamp);
    for (let i = 0; i < message.headers.length; i++)
      Header.internalBinaryWrite(message.headers[i], writer.tag(3, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    if (message.body.length)
      writer.tag(4, import_runtime9.WireType.LengthDelimited).bytes(message.body);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? import_runtime10.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
...
var ReadBatch$Type = class extends import_runtime12.MessageType {
  static {
  ...
  internalBinaryWrite(message, writer, options) {
    for (let i = 0; i < message.records.length; i++)
      SequencedRecord.internalBinaryWrite(message.records[i], writer.tag(1, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    if (message.tail)
      StreamPosition.internalBinaryWrite(message.tail, writer.tag(2, import_runtime9.WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? import_runtime10.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
...
//# sourceMappingURL=chunk-NIYKPRZ7.mjs.map
