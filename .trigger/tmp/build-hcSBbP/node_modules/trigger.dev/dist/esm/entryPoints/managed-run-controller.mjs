...
// node_modules/trigger.dev/dist/esm/entryPoints/managed-run-controller.js
init_esm();

// node_modules/trigger.dev/dist/esm/entryPoints/managed/controller.js
init_esm();

// node_modules/trigger.dev/dist/esm/entryPoints/managed/env.js
init_esm();
import { randomUUID } from "node:crypto";
var DateEnv = external_exports.string().transform((val) => new Date(parseInt(val, 10))).pipe(external_exports.date());
var BoolEnv = external_exports.preprocess((val) => {
...
// node_modules/trigger.dev/dist/esm/entryPoints/managed/logger.js
init_esm();
...
// node_modules/trigger.dev/dist/esm/entryPoints/managed/execution.js
init_esm();

// node_modules/trigger.dev/dist/esm/executions/taskRunProcess.js
init_esm();
var import_evt = __toESM(require_lib(), 1);
import { fork } from "node:child_process";

// node_modules/trigger.dev/dist/esm/utilities/cliOutput.js
init_esm();
...
// node_modules/trigger.dev/dist/esm/utilities/terminalLink.js
init_esm();
...
// node_modules/trigger.dev/dist/esm/utilities/supportsHyperlinks.js
init_esm();

// node_modules/trigger.dev/node_modules/supports-color/index.js
init_esm();
...
// node_modules/trigger.dev/node_modules/has-flag/index.js
init_esm();
import process4 from "process";
function hasFlag2(flag, argv = process4.argv) {
  const prefix = flag.startsWith("-") ? "" : flag.length === 1 ? "-" : "--";
  const position = argv.indexOf(prefix + flag);
  const terminatorPosition = argv.indexOf("--");
  return position !== -1 && (terminatorPosition === -1 || position < terminatorPosition);
...
// node_modules/@trigger.dev/core/dist/esm/v3/machines/index.js
init_esm();
...
var TaskRunProcess = class {
  ...
  async cleanup(kill = true) {
    ...
    await tryCatch2(this.#flush({ disableContext: !kill }));
    if (kill) {
      await this.#gracefullyTerminate(this.options.gracefulTerminationTimeoutInMs);
    }
  }
  ...
  async #flush({ timeoutInMs = 5e3, disableContext = false } = {}) {
    logger.debug("flushing task run process", { pid: this.pid });
    await this._ipc?.sendWithAck("FLUSH", { timeoutInMs, disableContext }, timeoutInMs + 1e3);
  }
  ...
  async execute(params, isWarmStart) {
    ...
    if (this._child?.connected && !this._isBeingKilled && !this._child.killed) {
      ...
      rejecter(new UnexpectedExitError(-1, null, "Child process is not connected, cannot execute task run"));
    }
...
// node_modules/trigger.dev/dist/esm/entryPoints/managed/poller.js
init_esm();
...
// node_modules/trigger.dev/dist/esm/entryPoints/managed/overrides.js
init_esm();
...
// node_modules/trigger.dev/dist/esm/entryPoints/managed/snapshot.js
init_esm();
...
// node_modules/trigger.dev/dist/esm/entryPoints/managed/notifier.js
init_esm();
...
// node_modules/trigger.dev/dist/esm/entryPoints/managed/taskRunProcessProvider.js
init_esm();
var TaskRunProcessProvider = class {
  ...
  machineId = generateFriendlyId("machine");
  ...
  async returnProcess(process5) {
    ...
    if (!this.processKeepAliveEnabled) {
      ...
      await process5.cleanup(true);
      return;
    }
    if (this.shouldKeepProcessAlive(process5)) {
      this.sendDebugLog("Keeping TaskRunProcess alive for next run", {
        executionCount: this.executionCount,
        maxExecutionCount: this.processKeepAliveMaxExecutionCount
      });
      await process5.cleanup(false);
      this.persistentProcess = process5;
      this.executionCount++;
    } else {
      this.sendDebugLog("Not keeping TaskRunProcess alive, cleaning up", {
        executionCount: this.executionCount,
        maxExecutionCount: this.processKeepAliveMaxExecutionCount,
        isHealthy: process5.isHealthy
      });
      await process5.cleanup(true);
    }
  }
  async suspendProcess(flush, process5) {
    if (this.persistentProcess) {
      if (process5) {
        if (this.persistentProcess.pid === process5.pid) {
   ...
   */
  async handleProcessAbort(process5) {
  ...
  async killProcess(process5) {
    this.sendDebugLog("Killing process");
    if (this.persistentProcess?.pid === process5.pid) {
      this.persistentProcess = null;
      this.executionCount = 0;
    }
    await this.cleanupProcess(process5);
  }
  /**
  ...
  shouldKeepProcessAlive(process5) {
    return this.executionCount < this.processKeepAliveMaxExecutionCount && process5.isHealthy;
  }
...
var ManagedRunController = class {
  ...
  processKeepAliveMaxExecutionCount;
  constructor(opts) {
    const env2 = new RunnerEnv(opts.env);
    this.env = env2;
    this.workerManifest = opts.workerManifest;
    ...
    this.httpClient = new WorkloadHttpClient({
      ...
      deploymentId: env2.TRIGGER_DEPLOYMENT_ID,
      deploymentVersion: env2.TRIGGER_DEPLOYMENT_VERSION,
      projectRef: env2.TRIGGER_PROJECT_REF
    });
    ...
    const properties = {
      ...env2.raw,
      TRIGGER_POD_SCHEDULED_AT_MS: env2.TRIGGER_POD_SCHEDULED_AT_MS.toISOString(),
      TRIGGER_DEQUEUED_AT_MS: env2.TRIGGER_DEQUEUED_AT_MS.toISOString()
    };
    this.sendDebugLog({
      runId: env2.TRIGGER_RUN_ID,
      message: "Creating run controller",
      properties
    });
    if (env2.TRIGGER_WARM_START_URL) {
      this.warmStartClient = new WarmStartClient({
        apiUrl: new URL(env2.TRIGGER_WARM_START_URL),
        controllerId: env2.TRIGGER_WORKLOAD_CONTROLLER_ID,
        deploymentId: env2.TRIGGER_DEPLOYMENT_ID,
        deploymentVersion: env2.TRIGGER_DEPLOYMENT_VERSION,
        machineCpu: env2.TRIGGER_MACHINE_CPU,
        machineMemory: env2.TRIGGER_MACHINE_MEMORY
      });
    }
