...
var digest = /* @__PURE__ */ __name((algorithm, data) => createHash(algorithm).update(data).digest(), "digest");
...
var encode = /* @__PURE__ */ __name((input) => Buffer2.from(input).toString("base64url"), "encode");
var decode = /* @__PURE__ */ __name((input) => new Uint8Array(Buffer2.from(normalize(input), "base64url")), "decode");
...
var iv_default = /* @__PURE__ */ __name((alg) => randomFillSync(new Uint8Array(bitLength(alg) >> 3)), "default");
...
var is_key_object_default = /* @__PURE__ */ __name((obj) => util.types.isKeyObject(obj), "default");
...
var isCryptoKey = /* @__PURE__ */ __name((key) => util2.types.isCryptoKey(key), "isCryptoKey");
...
var ciphers;
var ciphers_default = /* @__PURE__ */ __name((algorithm) => {
...
init_esm();
var is_key_like_default = /* @__PURE__ */ __name((key) => is_key_object_default(key) || isCryptoKey(key), "default");
...
var decrypt = /* @__PURE__ */ __name((enc, cek, ciphertext, iv, tag2, aad) => {
  let key;
  if (isCryptoKey(cek)) {
...
var getNamedCurve2 = /* @__PURE__ */ __name((kee, raw) => {
  let key;
  if (isCryptoKey(kee)) {
...
var ecdhAllowed = /* @__PURE__ */ __name((key) => ["P-256", "P-384", "P-521", "X25519", "X448"].includes(get_named_curve_default(key)), "ecdhAllowed");
...
var encrypt = /* @__PURE__ */ __name(async (alg, key, cek, p2c = 2048, p2s2 = randomFillSync(new Uint8Array(16))) => {
  checkP2s(p2s2);
...
var decrypt2 = /* @__PURE__ */ __name(async (alg, key, encryptedKey, p2c, p2s2) => {
  checkP2s(p2s2);
  const salt = p2s(alg, p2s2);
  const keylen = parseInt(alg.slice(13, 16), 10) >> 3;
  const password = getPassword(key, alg);
...
var check_key_length_default = /* @__PURE__ */ __name((key, alg) => {
  let modulusLength;
  try {
...
__name(ensureKeyObject2, "ensureKeyObject");
var encrypt2 = /* @__PURE__ */ __name((alg, key, cek) => {
...
var decrypt3 = /* @__PURE__ */ __name((alg, key, encryptedKey) => {
  const padding = resolvePadding(alg);
  const oaepHash = resolveOaepHash(alg);
...
var cek_default = /* @__PURE__ */ __name((alg) => randomFillSync(new Uint8Array(bitLength2(alg) >> 3)), "default");
...
var fromPKCS8 = /* @__PURE__ */ __name((pem) => createPrivateKey({
  key: Buffer4.from(pem.replace(/(?:-----(?:BEGIN|END) PRIVATE KEY-----|\s)/g, ""), "base64"),
  type: "pkcs8",
  format: "der"
}), "fromPKCS8");
var fromSPKI = /* @__PURE__ */ __name((pem) => createPublicKey({
  key: Buffer4.from(pem.replace(/(?:-----(?:BEGIN|END) PUBLIC KEY-----|\s)/g, ""), "base64"),
  type: "spki",
  format: "der"
}), "fromSPKI");
var fromX509 = /* @__PURE__ */ __name((pem) => createPublicKey({
  key: pem,
  type: "spki",
  format: "pem"
}), "fromX509");
...
var encrypt3 = /* @__PURE__ */ __name((enc, plaintext, cek, iv, aad) => {
  let key;
  if (isCryptoKey(cek)) {
...
//# sourceMappingURL=esm-A2BNSC52.mjs.map
