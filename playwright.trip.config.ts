...
export default defineConfig({
  ...
  retries: 0,
  testDir: "./e2e",
  testMatch: ["trip-timeline.fixture.spec.ts", "trip-location-follow.fixture.spec.ts", "trip-booked-stay-marker.fixture.spec.ts", "apple-maps-offline.fixture.spec.ts", "spoken-caption-layout.fixture.spec.ts", "artifact-card.fixture.spec.ts", "private-video-player.fixture.spec.ts", "private-pdf-viewer.fixture.spec.ts"],
  timeout: 30_000,
  use: {
