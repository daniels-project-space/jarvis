...
const TEAM = [
  ...
  },
  {
    ...
    description: "Researches audiences, builds campaigns, prepares channel-ready drafts, and reports verified performance.",
    capabilities: ["social-strategy", "content-planning", "copywriting", "campaigns", "analytics"],
    projectScopes: ["*"],
    defaultModel: "terra",
    autonomy: "draft-only",
  },
